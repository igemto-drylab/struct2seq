...
ARGS="--features full --restore .\log\h128_full\checkpoints\epoch2_step80.pt --file_data ../data/cath/chain_set.jsonl --file_splits ../data/SPIN2/test_split_sc.json"
python test_redesign.py --seed 105716977 --features full --restore .\log\h128_full\checkpoints\epoch1_step45.pt --file_data ..\data\chain_set.jsonl --file_splits ..\data\SPIN2\test_split_sc.json > .\designs\sc_full_1.log
python3 test_redesign.py --seed 222 ${ARGS} > designs/sc_full_2.log
python3 test_redesign.py --seed 333 ${ARGS} > designs/sc_full_3.log
python3 test_redesign.py --seed 444 ${ARGS} > designs/sc_full_4.log

python test_redesign.py --seed 105716977 --features full --restore .\experiments\log\best_checkpoint_epoch20.pt --file_data ..\data\sriracha_set.jsonl > ./designs/sriracha.log
